  ...
  projects.forEach((p) => {
    ...
    if (hasDemo || hasRepo) {
      const demoBtn = hasDemo
        ? `<a href="${p.demo}" target="_blank" rel="noopener" class="card-btn">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            開啟工具
           </a>`
        : '';
      const repoBtn = hasRepo
        ? `<a href="${p.repo}" target="_blank" rel="noopener" class="card-btn" aria-label="GitHub">
        ...
        : '';
      linksHtml = `<div class="card-links">${demoBtn}${repoBtn}</div>`;
    }
